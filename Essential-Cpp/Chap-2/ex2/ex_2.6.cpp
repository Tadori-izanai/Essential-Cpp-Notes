...
// }
template<typename aT>
inline aT max(const aT a[], int n)          // Apple clang version 12.0.5 加 const 不卒
{
    return *max_element(a, a + n);
}
